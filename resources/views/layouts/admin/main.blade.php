<!DOCTYPE html>
<html class="dark" x-data="data()" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container grid px-6 mx-auto">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        <!-- Card -->
                        <div
                            class="flex items-center p-4 bg-white border rounded-lg shadow-xs dark:bg-gray-800 dark:border-none">
                            <div
