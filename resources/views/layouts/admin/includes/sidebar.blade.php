...
<div class="py-4 text-gray-500 dark:text-gray-400">
    <a href="{{ route('home') }}" class="ml-6 text-xl text-gray-500 dark:text-gray-200 flex items-center gap-2" href="{{ route('admin.dashboard') }}">
    ...
    <ul class="mt-6">
        ...
        @can('viewany', 'App\\Models\User')
            <li class="relative px-6 py-3">
                <a href="{{ url('/telescope') }}" target="_blank" class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
